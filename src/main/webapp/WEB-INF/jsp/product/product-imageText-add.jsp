...
<div class="bjui-pageContent" style="overflow: auto;">
    <form action="${path }/admin/productImageTextAdd" data-toggle="validate">
        ...
        <table class="table table-bordered table-hover table-striped">
            <tbody>
            	<tr>
                    <td>
                        <label for="j_custom_total" class="control-label x85">文字描述：</label>
                        <input type="text" name="detail" value="" size="15">
                    </td>
                </tr>
                <tr>
                    <td> 
                        ...
                        <div style="display:inline-block; vertical-align:middle;">
						    <div id="doc_pic_up" data-toggle="upload" 
						        ...
						        <input type="hidden" name="image" value="" id="doc_pic">
					        </div>
						</div>
