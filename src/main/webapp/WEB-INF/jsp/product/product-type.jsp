...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${path }/admin/productType" method="post">
        ...
        <div class="bjui-searchBar">
        	<!-- 添加 -->
        	<a class="btn btn-default" href="${path }/admin/productTypeAddInit?tabid=${tabid}" data-toggle="dialog" data-width="800" data-height="600" data-mask="true" data-title="添加类型">添加类型</a>
        </div>
    </form>
</div>
