...
<div class="bjui-pageContent" style="overflow: auto;">
    <form action="${path }/admin/productParamAdd" data-toggle="validate">
            ...
            <tbody>
            	<tr>
                    <td>
                        ...
                        <input type="text" name="key" value="" size="15" data-rule="required">
                    </td>
                </tr>
            	<tr>
                    <td>
                        <label for="j_custom_total" class="control-label x85">参数描述：</label>
                        <input type="text" name="detail" value="" size="15" data-rule="required">
                    </td>
                </tr>
            </tbody>
        </table>
