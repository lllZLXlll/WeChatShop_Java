...
<div class="bjui-pageContent" style="overflow: auto;">
    <form action="${path }/admin/productClassEdit" data-toggle="validate">
            ...
            <tbody>
            	<tr>
                    <td>
                        ...
                        <input type="text" name="className" value="${item.className }" size="15" data-rule="required">
                    </td>
                </tr>
                <tr>
                    <td> 
                        ...
                        <div style="display:inline-block; vertical-align:middle;">
						    <div id="doc_pic_up" data-toggle="upload" 
						        ...
						        <input type="hidden" name="productImage" value="${item.productImage }" id="doc_pic" data-rule="required">
					        </div>
						</div>
                        <span id="doc_span_pic">
                        	<img src="${item.productImage }" width="90" height="90">
                        </span>
                    </td>
                </tr>
            	<tr>
                    <td>
				        ...
				        <input type="text" name="price" size="15" value="${item.price }" data-rule="required;number">
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="j_custom_total" class="control-label x85">库存：</label>
                        <input type="text" data-toggle="spinner" name="count" value="${item.count }" size="5" data-min="0">
                    </td>
                </tr>
            </tbody>
        </table>
