...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${path }/admin/homeRecommended" method="post">
	           	...
	           	<c:otherwise>
			    	...
			    	<c:forEach items="${page.page }" var="item" varStatus="status">
				        <tr height="30">
				            ...
				            <td align="center">
			            		<a class="btn btn-default" href="${path }/admin/homeRecommendedEditInit?id=${item.id }&tabid=${tabid}" data-toggle="dialog" data-width="800" data-height="600" data-mask="true" data-id="homeBannerEditInit" data-title="推荐商品编辑">编辑</a>
								&nbsp;|&nbsp;
								<a class="btn btn-red" href="${path }/admin/homeRecommendedUpdateStatus?id=${item.id }&status=3" data-toggle="doajax" data-confirm-msg="确定要删除吗？">删除</a>
							</td>
				        </tr>
			        </c:forEach>
		       	</c:otherwise>
