...
<div class="bjui-pageContent">
	<form id="j_pwschange_form" action="${path }/admin/changePwd" data-toggle="validate" method="post">
        ...
        <div class="form-group">
            ...
            <input type="password" data-rule="required" name="password" id="j_pwschange_oldpassword" value="" placeholder="旧密码" size="20">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="password" data-rule="required;match(pass)" name="secPassword" id="j_pwschange_secpassword" value="" placeholder="确认新密码" size="20">
        </div>
	</form>
</div>
