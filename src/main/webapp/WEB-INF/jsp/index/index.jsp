                	...
                	<li class="active"><a href="javascript:;" data-toggle="slidebar">小程序首页管理</a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree1" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="star-o" data-tit="小程序首页管理">
                                <li data-url="${path }/admin/homeBanner?tabid=submenu-tab-1" data-tabid="submenu-tab-1" data-toggle="navtab" data-fresh="true" data-faicon="caret-right">轮播图</li>
                                <li data-url="${path }/admin/homeRecommended?tabid=submenu-tab-2" data-tabid="submenu-tab-2" data-toggle="navtab" data-fresh="true" data-faicon="caret-right">推荐商品</li>
                                <li data-url="${path }/admin/homeActivity?tabid=submenu-tab-3" data-tabid="submenu-tab-3" data-toggle="navtab" data-fresh="true" data-faicon="caret-right">活动专区</li>
                    ...
                    <li><a href="javascript:;" data-toggle="slidebar">商品管理</a>
                        <div class="items hide" data-noinit="true">
                            <ul id="bjui-hnav-tree2" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-faicon="star-o" data-tit="商品管理">
                                <li data-pid="0" data-url="${path }/admin/productType?tabid=submenu-tab-4" data-tabid="submenu-tab-4" data-toggle="navtab" data-fresh="true" data-faicon="caret-right">商品分类</li>
